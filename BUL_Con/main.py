text = """"We, the Members of the Seventh Grand National Assembly, guided by our desire to express the will of the people of Bulgaria, by pledging our loyalty to the universal human values of liberty, peace, humanism, equality, justice and tolerance;
...
(3) (new, SG 18/05) Republic of Bulgaria shall participate in the building and development of the European Union.
...
Art. 39. (1) Everyone shall be entitled to express an opinion or to publicize it through words, written or oral, sound or image, or in any other way.
...
16. (new - SG. 27/06, amend. – SG, 12/07, suppl. SG, 100/15) hold a hearing and approve the annual reports of the Supreme Court of Cassation, the Supreme Administrative Court and the Prosecutor General, submitted by the Supreme Judicial Council, on the application of the law and on the activities of the courts, the Prosecutor’s Office and the investigating bodies. The National Assembly may hold a hearing and approve other reports of the Prosecutor General on the activities of the Prosecutor’s Office on the application of the law, the fight against crime and the implementation of the criminal policy;
...
(6) The procedure for forming a government established by the preceding paragraphs shall further apply in the cases referred to in Art. 111 para 1.
...
(3) Each member of the Council of Ministers shall head a ministry, except when the National Assembly resolves other-wise. Each minister shall account for his own activity.
...
(2) Citizens and legal entities shall be free to challenge any administrative act which affects them, except those listed expressly by the laws.
...
4. (prev. item 2 SG 27/06) by overseeing the enforcement of penalties and other measures of compulsion; 5. (prev. item 3 SG 27/06) by acting for the rescission of all inlawful acts;
...
Art. 129.
(1) (Suppl., SG 100/15) Judges, prosecutors and investigating magistrates shall be appointed, promoted, demoted, transferred and released from office by the Judges’ College and by the Prosecutors’ College of the Supreme Judicial Council respectively.
(2) (Suppl., SG 100/15) The Chairman of the Supreme Court of Cassation, the Chairman of the Supreme Administrative Court and the Prosecutor General shall be appointed and released by the President of the Republic upon a proposal by the Plenary of the Supreme Judicial Council for a term of seven years and shall not be eligible for a second term in office. The President shall not deny an appointment or release upon a repeated proposal.
(3) (Amend., SG 85/03, Suppl., SG, 100/15) Having completed a five year term of office as a judge, prosecutor or investigating magistrate, and upon attestation, by decision of the Judges’ College and the Prosecutors’ College of the Supreme Judicial Council respectively, the judges, prosecutors and investigating magistrates shall become irremovable. They, including the persons referred to in para 2 shall be released from office only upon:
1. completion of 65 years of age;
2. resignation;
3. judgment which has the force of res judicata for a penalty of deprivation of liberty for an intentionally committed criminal offence;
4. permanent de facto inability to perform their duties for more than a year;
5. serious infringement or systematic neglect of their official duties, as well as actions damaging the prestige of the judiciary.
...
(3) (Suppl. - SG, 100/15) Eleven of the members of the Supreme Judicial Council shall be elected by the National Assembly by a two-thirds majority of the national representatives and eleven shall be elected by the bodies of the judiciary. The members of the Supreme Judicial Council shall be elected under the terms of Art. 130a (3) and (4) and in accordance with a procedure established by law.
...
(5) (revoked - SG 100/15).
(6) (new-SG 12/07; revoked - SG 100/15).
(7) (New-SG 12/07; revoked - SG 100/15).
(8) (New-SG 12/07) The mandate of an elected member of the Supreme Judicial Council shall expire upon any of the following occurrences:
1. resignation;
...
Art. 130a.
(New, SG 100/15) (1) The Supreme Judicial Council shall exercise its powers through a Plenary, a Judges’ college and a Prosecutors’ college.
(2) The Plenary shall consist of all members of the Supreme Judicial Council. The Plenary of the Supreme Judicial Council shall:
1. approve the draft budget of the judiciary;
2. adopt a decision to terminate the mandate of an elected member of the Supreme Judicial Council under the conditions of Art. 130 (8);
3. organize the qualification of judges, prosecutors and investigating magistrates;
4. decide on organizational issues common to the judiciary;
5. hold a hearing and accepts the annual reports under Art. 84, item 16;
6. manage the immovable property of the judiciary;
7. make a proposal to the President of the Republic for the appointment and dismission of the Chairman of the Supreme Court of Cassation, the Chairman of the Supreme Administrative Court and the Prosecutor General;
8. exercise other powers, as defined by law.
(3) The Judges’ College of the Supreme Judicial Council shall consist of 14 members and shall include the Chairmen of the Supreme Court of Cassation and of the Supreme Administrative Court, six members elected directly by the judges and six members elected by the National Assembly.
...
(5) The Colleges each acting within its professional domain, shall perform the following functions:
1. appoint, promote, relocate and release from office the judges, prosecutors and investigating magistrates;
2. make periodic attestations to judges, prosecutors, investigating magistrates and administrative heads in the judicial authorities and shall decide on matters related to acquisition and restoration of irremovability;
3. impose disciplinary sanctions of demotion and release from office on the judges, prosecutors, , investigating magistrates and administrative heads in the judicial authorities;
4. appoint and dismiss the administrative heads in the judicial authorities;
5. resolve matters related to the organization of the operation of the respective system of judicial authorities;
6. exercise other powers as defined by law.

Art. 130b.
(New - SG 100/15) (1) The meetings of the plenum of the Supreme Judicial Council shall be chaired by the Minister of Justice. The Minister shall not take part in the votes.
(2) The Judges’ College of the Supreme Judicial Council shall be chaired by the Chairman of the Supreme Court of Cassation. The Prosecutors’ College of the Supreme Judicial Council shall be chaired by the Prosecutor General. The Minister of Justice may attend the meetings but shall not take part in the votes. 
(3) The Inspector General may attend the meetings of the Plenum of the Supreme Judicial Council and the meetings of the Judges’ and Prosecutors’ Colleges of the Supreme Judicial Council but shall not take part in the votes.

Art. 130c.
(New - SG 27/2006, prev. Art. 130a - SG, 100/15) The Minister of Justice shall:
1. (amend. SG 100/15) propose a draft budget of the judiciary and submit it to the Supreme Judicial Council;
2. (revoked, SG 100/15);
3. be able to make proposals for appointment, promotion, demotion, transfer and release from office of judges, prosecutors and investigating magistrates;
4. participate in the organization of qualification of the judges, prosecutors and investigating magistrates;.
5. (revoked - SG 12/07).

Art. 131.
(Amend.-SG 85/03, amend.-SG 12/07; revoked - SG 100/15).
...
(6) (amend. - SG 100/15) The Inspectorate shall inspect the operation of the judicial authorities without affecting the independence of judges, jurors, prosecutors and investigating magistrates in the performance of their duties. The Inspectorate shall carry out checks on the integrity and the conflicts of interest of judges, prosecutors and investigating magistrates, their property declarations, as well as for ascertaining any actions damaging the prestige of the judiciary and such violating the independence of judges, prosecutors and investigating magistrates. The Inspector General and the inspectors shall be independent and shall obey only the law while performing their duties.
...
(2) The judges of the Constitutional Court shall be elected or appointed for a period of nine years and shall not be eligible for re-election or
...
(4) (new – 100/15) The Supreme Bar Council may refer to the Constitutional Court a request for declaring as unconstitutional an Act which violates rights and freedoms of citizens.
...
TRANSITIONAL AND FINAL PROVISIONS (SG 100/15)


§ 9.
Within three months of entry into force of this Act the National Assembly shall pass the acts relating to the application of Art. 130a and 130b.

§ 10.
By the date of entry into force of this Act the elected members of the Supreme Judicial Council shall complete their mandate.

§ 11.
(1) Within one month from entry into force of the laws which relate to the application of Art. 130a and 130b, the Supreme Judicial Council shall assign the members of the council elected by the National Assembly to the Judges’ and the Prosecutors’ Colleges of the Supreme Judicial Council.
(2) If within the term under para. 1 the Supreme Judicial Council fails to assign the members of the council elected by the National Assembly to the Judges’ and the Prosecutors’ Colleges, the National Assembly shall assign them by a resolution.
"""
